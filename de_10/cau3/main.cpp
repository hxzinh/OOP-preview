...
int main()
{
	...
	do
	{
		...
		//Kiem tra hop le nhom mau
		if (Cha != "A" && Cha != "B" && Cha != "AB" && Cha != "O")
			cout << "Nhom mau khong hop le! Nhap lai!\n";
	} while (Cha != "A" && Cha != "B" && Cha != "AB" && Cha != "O");
	do
	{
		cout << "Nhap nhom mau nguoi me: "; getline(cin, Me);
		//Kiem tra hop le nhom mau
		if (Me != "A" && Me != "B" && Me != "AB" && Me != "O")
			cout << "Nhom mau khong hop le! Nhap lai!\n";
	} while (Me != "A" && Me != "B" && Me != "AB" && Me != "O");
	do
	{
		cout << "Nhap nhom mau nguoi con: "; getline(cin, Con);
		//Kiem tra hop le nhom mau
		if (Con != "A" && Con != "B" && Con != "AB" && Con != "O")
			cout << "Nhom mau khong hop le! Nhap lai!\n";
	} while (Con != "A" && Con != "B" && Con != "AB" && Con != "O");
